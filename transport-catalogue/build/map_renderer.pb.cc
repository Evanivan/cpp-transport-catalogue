...
PROTOBUF_CONSTEXPR MapSettings::MapSettings(
    ::_pbi::ConstantInitialized): _impl_{
...
struct MapSettingsDefaultTypeInternal {
  PROTOBUF_CONSTEXPR MapSettingsDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~MapSettingsDefaultTypeInternal() {}
  union {
    MapSettings _instance;
  };
};
...
const uint32_t TableStruct_map_5frenderer_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::map_render_serialize::Pair, _impl_.first_),
  PROTOBUF_FIELD_OFFSET(::map_render_serialize::Pair, _impl_.second_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::map_render_serialize::MapSettings, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::map_render_serialize::MapSettings, _impl_.width_),
  PROTOBUF_FIELD_OFFSET(::map_render_serialize::MapSettings, _impl_.height_),
  PROTOBUF_FIELD_OFFSET(::map_render_serialize::MapSettings, _impl_.padding_),
  PROTOBUF_FIELD_OFFSET(::map_render_serialize::MapSettings, _impl_.stop_radius_),
  PROTOBUF_FIELD_OFFSET(::map_render_serialize::MapSettings, _impl_.line_width_),
  PROTOBUF_FIELD_OFFSET(::map_render_serialize::MapSettings, _impl_.bus_label_font_size_),
  PROTOBUF_FIELD_OFFSET(::map_render_serialize::MapSettings, _impl_.bus_label_offset_),
  PROTOBUF_FIELD_OFFSET(::map_render_serialize::MapSettings, _impl_.stop_label_font_size_),
  PROTOBUF_FIELD_OFFSET(::map_render_serialize::MapSettings, _impl_.stop_label_offset_),
  PROTOBUF_FIELD_OFFSET(::map_render_serialize::MapSettings, _impl_.underlayer_color_),
  PROTOBUF_FIELD_OFFSET(::map_render_serialize::MapSettings, _impl_.underlayer_width_),
...
Pair::Pair(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:map_render_serialize.Pair)
}
Pair::Pair(const Pair& from)
  ...
  // @@protoc_insertion_point(copy_constructor:map_render_serialize.Pair)
}
...
Pair::~Pair() {
  // @@protoc_insertion_point(destructor:map_render_serialize.Pair)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
void Pair::Clear() {
// @@protoc_insertion_point(message_clear_start:map_render_serialize.Pair)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 9)) {
          _impl_.first_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<double>(ptr);
          ptr += sizeof(double);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* Pair::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:map_render_serialize.Pair)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;

  // double first = 1;
  static_assert(sizeof(uint64_t) == sizeof(double), "Code assumes uint64_t and double are the same size.");
  double tmp_first = this->_internal_first();
  uint64_t raw_first;
  memcpy(&raw_first, &tmp_first, sizeof(tmp_first));
  if (raw_first != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteDoubleToArray(1, this->_internal_first(), target);
  }

  // double second = 2;
  static_assert(sizeof(uint64_t) == sizeof(double), "Code assumes uint64_t and double are the same size.");
  double tmp_second = this->_internal_second();
  uint64_t raw_second;
  memcpy(&raw_second, &tmp_second, sizeof(tmp_second));
  if (raw_second != 0) {
    target = stream->EnsureSpace(target);
  ...
  // @@protoc_insertion_point(serialize_to_array_end:map_render_serialize.Pair)
  return target;
}

size_t Pair::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:map_render_serialize.Pair)
  size_t total_size = 0;
...
void Pair::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:map_render_serialize.Pair)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;

  static_assert(sizeof(uint64_t) == sizeof(double), "Code assumes uint64_t and double are the same size.");
  double tmp_first = from._internal_first();
  uint64_t raw_first;
  memcpy(&raw_first, &tmp_first, sizeof(tmp_first));
  if (raw_first != 0) {
  ...
  static_assert(sizeof(uint64_t) == sizeof(double), "Code assumes uint64_t and double are the same size.");
  double tmp_second = from._internal_second();
  uint64_t raw_second;
  memcpy(&raw_second, &tmp_second, sizeof(tmp_second));
  if (raw_second != 0) {
...
// @@protoc_insertion_point(class_specific_copy_from_start:map_render_serialize.Pair)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void Pair::InternalSwap(Pair* other) {
  ...
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Pair, _impl_.second_)
      + sizeof(Pair::_impl_.second_)
      - PROTOBUF_FIELD_OFFSET(Pair, _impl_.first_)>(
...
MapSettings::_Internal::bus_label_offset(const MapSettings* msg) {
...
MapSettings::MapSettings(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:map_render_serialize.MapSettings)
}
MapSettings::MapSettings(const MapSettings& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  MapSettings* const _this = this; (void)_this;
  new (&_impl_) Impl_{
  ...
  if (from._internal_has_bus_label_offset()) {
    _this->_impl_.bus_label_offset_ = new ::map_render_serialize::Pair(*from._impl_.bus_label_offset_);
  }
  ...
  // @@protoc_insertion_point(copy_constructor:map_render_serialize.MapSettings)
}

inline void MapSettings::SharedCtor(
    ::_pb::Arena* arena, bool is_message_owned) {
  (void)arena;
  (void)is_message_owned;
  new (&_impl_) Impl_{
...
MapSettings::~MapSettings() {
  // @@protoc_insertion_point(destructor:map_render_serialize.MapSettings)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
inline void MapSettings::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
...
// @@protoc_insertion_point(message_clear_start:map_render_serialize.MapSettings)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* MapSettings::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::_pbi::ReadTag(ptr, &tag);
...
uint8_t* MapSettings::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:map_render_serialize.MapSettings)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:map_render_serialize.MapSettings)
  return target;
}

size_t MapSettings::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:map_render_serialize.MapSettings)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData MapSettings::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    MapSettings::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*MapSettings::GetClassData() const { return &_class_data_; }


void MapSettings::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<MapSettings*>(&to_msg);
  auto& from = static_cast<const MapSettings&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:map_render_serialize.MapSettings)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (from._internal_has_bus_label_offset()) {
    _this->_internal_mutable_bus_label_offset()->::map_render_serialize::Pair::MergeFrom(
        from._internal_bus_label_offset());
  }
  if (from._internal_has_stop_label_offset()) {
    _this->_internal_mutable_stop_label_offset()->::map_render_serialize::Pair::MergeFrom(
...
// @@protoc_insertion_point(class_specific_copy_from_start:map_render_serialize.MapSettings)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void MapSettings::InternalSwap(MapSettings* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(MapSettings, _impl_.underlayer_width_)
      + sizeof(MapSettings::_impl_.underlayer_width_)
      - PROTOBUF_FIELD_OFFSET(MapSettings, _impl_.bus_label_offset_)>(
...
template<> PROTOBUF_NOINLINE ::map_render_serialize::MapSettings*
Arena::CreateMaybeMessage< ::map_render_serialize::MapSettings >(Arena* arena) {
  return Arena::CreateMessageInternal< ::map_render_serialize::MapSettings >(arena);
}
