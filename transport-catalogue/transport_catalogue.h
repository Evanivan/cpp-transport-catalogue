...
namespace Transport {
    ...
    public:
        ...
        const domain::Stop *FindStop(std::string stop) const;
        ...
        int GetDistance(std::string stop1, std::string stop2) const;
        ...
        std::unordered_map<std::pair<const domain::Stop *, const domain::Stop *>, int, detail::DistanceHash> GetAllDist() const;

    private:
        std::deque<domain::Stop> stops_;
        std::unordered_map<std::string, const domain::Stop *, detail::StopBusHash> stopname_to_stop_;
